...
app.post("/new_post", (request, response) => {
	...
	const storage = multer.diskStorage({
		destination: function (req, file, cb) {
			if (data.type == "Blog") cb(null, path.join(__dirname, "/public/trinidad_blog/images/posts"));
			else cb(null, path.join(__dirname, "/public/project_dandelion/images/posts"));
		},
...
function initializeApp(app) {
	app.listen(port, () => console.log(chalk.green.bold(`>> Listening at ${port}`)));
